...
humidity의 경우 0 값이 22개 존재함. humidiy 값이 0인 경우를 결측치 대체함. 
windspeed가 0인 경우도 마찬가지로 결측치로 보고 대체함
weather의 경우 4 level의 빈도가 매우 작기 때문에 3 level과 통합 
```{r}
...
write.csv(subfile, row.names = FALSE,
          file.path(file_path, "xgb_Submission_winimp.csv")) 
```
