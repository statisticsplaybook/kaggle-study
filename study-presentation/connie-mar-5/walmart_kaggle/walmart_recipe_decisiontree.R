...
#교차검증 
set.seed(1234)
train2_fold <- vfold_cv(train2, strata = weekly_sales)
train2_fold
...
show_best(train2_fold, metric = "rmse")
??show_best
...
result <- predict(tree_fit, new_data = test2)
result %>% head
